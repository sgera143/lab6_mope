...
x3_min = -30
x3_max = -15
koefs = [3.8, 8.8, 9.8, 1.3, 3.1, 0.4, 10.0, 9.0, 0.8, 8.6, 7.5]
...
def main(m, n):
    ...
    if n == 4:
        ...
        x = [[1, x1_min, x2_min, x3_min],
            ...
            [1, x1_max, x2_max, x3_min]]
    if n == 14:
        y = [[round(sum([koefs[j] * i[j] for j in range(len(koefs))]) + random() * 10 - 5, 3) for k in range(m)] for i in x]
    else:
    ...
    table = {2: 0.75, 3: 0.6841, 4: 0.6287, 5: 0.5892, 6: 0.5598, 7: 0.5365, 8: 0.5175, 9: 0.5017, 10: 0.4884, range(11, 17): 0.4366, range(17, 37): 0.3720, range(37, 2 ** 100): 0.3093}
    ...
    if n == 14:
        beta_i = b_i
    f_3 = f_1 * f_2
    t_table = {4: 2.776, 5: 2.571, 6: 2.447, 7: 2.365, 8: 2.306, 9: 2.262, 10: 2.228, 11: 2.201, 12: 2.179, 13: 2.160, 14: 2.145, 15: 2.131, 16: 2.120, 17: 2.110, 18: 2.101, 19: 2.093, 20: 2.086, 21: 2.08, 22: 2.074, 23: 2.069, 24: 2.064, range(25, 30): 2.06, range(30, 40): 2.042, range(40, 60): 2.021, range(60, 100): 2, range(100, 2 ** 100): 1.96}
    ...
    f_p = s2_ad / s2_b
    f_t = {1: [164.4, 199.5, 215.7, 224.6, 230.2, 234, 235.8, 237.6],
